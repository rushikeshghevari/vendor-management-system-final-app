...
// Legacy compat: used by escalation.service.ts which passes {token, platform}
export interface PushPayload extends RichPushPayload {}
...
export async function sendPushToToken(
  ...
  const result = await sendPushToTokens([{ token, userId, platform: 'android' }], payload);
