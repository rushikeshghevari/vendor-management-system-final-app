...
import type { BillApprovalDecision } from '@/features/bills/types';

interface BillDecisionSheetProps {
  decision: BillApprovalDecision | null;
...
const DECISION_COPY: Record<
  ...
  { title: string; icon: keyof typeof Ionicons.glyphMap; confirmLabel: string; remarksRequired: boolean }
> = {
...
/** Each approver's decision is independent — this never blocks on another approver's
 *  action. Mirrors components/quotations/DirectorDecisionSheet.tsx exactly. */
export function BillDecisionSheet({ decision, isSubmitting = false, onConfirm, onClose }: BillDecisionSheetProps) {
